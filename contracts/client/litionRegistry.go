...
//
// Solidity: function registerChain(string description, string initEndpoint, address chainValidator, uint256 maxNumOfValidators, uint256 vesting, uint256 maxNumOfTransactors, bool involvedVestingNotaryCond, bool participationNotaryCond) returns(uint256 chainId)
func (_LitionScClient *LitionScClientTransactor) RegisterChain(opts *bind.TransactOpts, description string, initEndpoint string, chainValidator common.Address, maxNumOfValidators *big.Int, vesting *big.Int, maxNumOfTransactors *big.Int, involvedVestingNotaryCond bool, participationNotaryCond bool) (*types.Transaction, error) {
	return _LitionScClient.contract.Transact(opts, "registerChain", description, initEndpoint, chainValidator, maxNumOfValidators, vesting, maxNumOfTransactors, involvedVestingNotaryCond, participationNotaryCond)
}

// RegisterChain is a paid mutator transaction binding the contract method 0xab1e2f74.
//
// Solidity: function registerChain(string description, string initEndpoint, address chainValidator, uint256 maxNumOfValidators, uint256 vesting, uint256 maxNumOfTransactors, bool involvedVestingNotaryCond, bool participationNotaryCond) returns(uint256 chainId)
func (_LitionScClient *LitionScClientSession) RegisterChain(description string, initEndpoint string, chainValidator common.Address, maxNumOfValidators *big.Int, vesting *big.Int, maxNumOfTransactors *big.Int, involvedVestingNotaryCond bool, participationNotaryCond bool) (*types.Transaction, error) {
	return _LitionScClient.Contract.RegisterChain(&_LitionScClient.TransactOpts, description, initEndpoint, chainValidator, maxNumOfValidators, vesting, maxNumOfTransactors, involvedVestingNotaryCond, participationNotaryCond)
}

// RegisterChain is a paid mutator transaction binding the contract method 0xab1e2f74.
//
// Solidity: function registerChain(string description, string initEndpoint, address chainValidator, uint256 maxNumOfValidators, uint256 vesting, uint256 maxNumOfTransactors, bool involvedVestingNotaryCond, bool participationNotaryCond) returns(uint256 chainId)
func (_LitionScClient *LitionScClientTransactorSession) RegisterChain(description string, initEndpoint string, chainValidator common.Address, maxNumOfValidators *big.Int, vesting *big.Int, maxNumOfTransactors *big.Int, involvedVestingNotaryCond bool, participationNotaryCond bool) (*types.Transaction, error) {
	return _LitionScClient.Contract.RegisterChain(&_LitionScClient.TransactOpts, description, initEndpoint, chainValidator, maxNumOfValidators, vesting, maxNumOfTransactors, involvedVestingNotaryCond, participationNotaryCond)
}
