...
// Notary is a paid mutator transaction binding the contract method 0x0a13f13b.
//
// Solidity: function notary(uint256 id, uint256 notary_block_no, address[] miners, uint32[] blocks_mined, address[] users, uint32[] user_gas, uint32 largest_tx, uint8[] v, bytes32[] r, bytes32[] s) returns()
func (_LitionScClient *LitionScClientTransactor) Notary(opts *bind.TransactOpts, id *big.Int, notary_block_no *big.Int, miners []common.Address, blocks_mined []uint32, users []common.Address, user_gas []uint32, largest_tx uint32, v []uint8, r [][32]byte, s [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function notary(uint256 id, uint256 notary_block_no, address[] miners, uint32[] blocks_mined, address[] users, uint32[] user_gas, uint32 largest_tx, uint8[] v, bytes32[] r, bytes32[] s) returns()
func (_LitionScClient *LitionScClientSession) Notary(id *big.Int, notary_block_no *big.Int, miners []common.Address, blocks_mined []uint32, users []common.Address, user_gas []uint32, largest_tx uint32, v []uint8, r [][32]byte, s [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function notary(uint256 id, uint256 notary_block_no, address[] miners, uint32[] blocks_mined, address[] users, uint32[] user_gas, uint32 largest_tx, uint8[] v, bytes32[] r, bytes32[] s) returns()
func (_LitionScClient *LitionScClientTransactorSession) Notary(id *big.Int, notary_block_no *big.Int, miners []common.Address, blocks_mined []uint32, users []common.Address, user_gas []uint32, largest_tx uint32, v []uint8, r [][32]byte, s [][32]byte) (*types.Transaction, error) {
	return _LitionScClient.Contract.Notary(&_LitionScClient.TransactOpts, id, notary_block_no, miners, blocks_mined, users, user_gas, largest_tx, v, r, s)
}
