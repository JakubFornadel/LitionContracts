...
contract LitionRegistry {
    ...
    uint256 constant MIN_NOTARY_PERIOD           = 60;    // mainnet: 1440, testnet: 60 
    ...
    uint256 constant CHAIN_INACTIVITY_TIMEOUT    = 1 days;  // mainnet: 7, testnet 1 days 
    
    // Time after which validators can withdraw their vesting
    uint256 constant VESTING_LOCKUP_TIMEOUT      = 1 days;  // mainnet: 7, testnet 1 days
